...
// Amazon DynamoDB Streams events handlers. If f is a function with the
// appropriate signature, HandlerFunc(f) is a Handler that calls f after
// unmarshaling the raw json event.
